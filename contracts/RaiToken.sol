...
contract RaiToken is ERC20("RaiToken", "RAI"), Ownable {
    ...
    function delegateBySig(
        ...
        require(
            signatory != address(0),
            "RAI::delegateBySig: invalid signature"
        );
        require(
            nonce == nonces[signatory]++,
            "RAI::delegateBySig: invalid nonce"
        );
    ...
    returns (uint256)
    {
        require(
            ...
            "RAI::getPriorVotes: not yet determined"
        );
    ...
    function _writeCheckpoint(
        ...
        uint32 blockNumber = safe32(
            block.number,
            "RAI::_writeCheckpoint: block number exceeds 32 bits"
        );
